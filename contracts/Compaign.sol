...
contract Campaign  {
   ...
   // Token claiming by users
    ...
    function buyTokens() public payable {
        ...
        // require(checkQualifyingTokens(msg.sender), "Insufficient POLR tokens to qualify");
        require(checkStakedTokens(msg.sender), "Insufficient POLR tokens to qualify");
     ...
     * @notice - Access control: External
     */
    function checkStakedTokens(address _user) public  view returns(bool) {
        ...
        Staker stakerContract = Staker(stakerAddress);
        uint256 stakedBalance = stakerContract.stakedBalance(_user);
        return (stakedBalance >= qualifyingTokenQty);
    }
...
contract Factory is IFactoryGetters, Ownable {
     ...
     * @notice - [4] QualifyingTokenQty. Number of POLR required to participate. In 1e18 per POLR.
     ...
     * @notice - [0] Min amount in MATIC, per purchase.
     * @notice - [1] Max accumulated amount in MATIC.
    ...
    function createCampaign(
        ...
        uint256 _subIndex,
        address _campaignOwner,
        uint256[5] memory _stats,
        uint256[3] memory _dates,
        uint256[2] memory _buyLimits,
        Campaign.Accessibility _access,
